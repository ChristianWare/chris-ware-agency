        ...
        <div className={styles.content}>
          <div className={styles.left}>
            ...
            <p className={styles.copy}>
              At the Chris Ware Agency, we Merge Imagination and Innovation in
              Web Design and Development, Crafting Websites that Captivate,
              Convert, and Catapult Businesses to New Heights in the Digital
              Landscape.
            </p>
