        ...
        <div className={styles.bottom}>
          ...
          <div className={styles.right}>
            ...
            <p>
              ...
              thriving career. As the driving force behind The Chris Ware
              Agency, I am dedicated to combining cutting-edge technologies with
              innovative design to build websites that not only meet my
              clients&rsquo; needs but also exceed their expectations. With a
              deep-rooted commitment to continuous learning and a keen eye for
              detail, I am excited to bring your web projects to life and create
